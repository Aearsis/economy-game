...
makable_pricelist = [(s, int(max_price * randfloat(0.1, 0.8))) for s in makable]
...
# make dicts:
all_pricelist = dict(minable_pricelist + market_pricelist + tools_pricelist + makable_pricelist)
...
#        needs_cost = sum(all_pricelist[n]*a for n, a in r.consumes)
#    except KeyError:
#       queue.append(r)
#        continue
