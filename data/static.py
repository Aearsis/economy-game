...
all_goods = (
    ...
    EntityTuple("Bambusová trubka", 60, strategic=True),
    ...
    EntityTuple("Ebenová deska", 600, strategic=True),
    ...
    EntityTuple("Lepicí kámen", 600, strategic=True),
    ...
    EntityTuple("Vor", 600, strategic=True, sell=False),
    EntityTuple("Včelí plástev", 120, token_amount=1),
    EntityTuple("Zub šavlozubého tygra", 6),
    EntityTuple("Špagát", 600, strategic=True),
